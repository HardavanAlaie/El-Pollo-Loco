...
class Character extends MovableObject {
  ...
  constructor(world) {
    ...
    this.loadImages(this.IMAGES_DEAD);
    this.applyGravity();
    this.start(); // 👈 beim ersten Laden gleich starten
  }

  /**
   * Startet alle Bewegungs- und Animations-Intervalle
   */
  start() {
    this.stop(); // sicherstellen, dass nichts doppelt läuft
  ...
  /**
   * Stoppt alle Character-Intervalle
   */
  stop() {
